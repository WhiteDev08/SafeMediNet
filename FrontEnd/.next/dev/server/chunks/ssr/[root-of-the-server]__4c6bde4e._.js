...
async function getNursePatients(nurseId) {
    try {
        const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(db, 'patients'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('assignedNurse', '==', nurseId));
...
async function validateCredentials(userId, password, role) {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleLogin"])(userId, password, role);
...
function useAuth() {
   ...
   */ const login = async (userId, password, role)=>{
        try {
            ...
            const authenticatedUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateCredentials"])(userId, password, role);
            if (authenticatedUser) {
                // Store user and redirect to portal
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setStoredUser"])(authenticatedUser);
                setUser(authenticatedUser);
                router.push(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROLE_ROUTES"][role]);
                setIsLoading(false);
                return true;
            }
            setIsLoading(false);
   ...
   */ const signup = async (userData, role)=>{
        try {
            ...
            const { createUser, createDoctor, createNurse, createPatient } = await __turbopack_context__.A("[project]/firebase.ts [app-ssr] (ecmascript, async loader)");
...
"[project]/components/patient-sidebar.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PatientSidebar() {
    const { logout, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const navItems = [
        {
            label: "Dashboard",
...
function AuthGuard({ children, requiredRole }) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, isLoading, hasRole } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isLoading) return;
        if (!user) {
            router.push("/");
...
"[project]/components/patient-chatbot.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c6bde4e._.js.map