...
import { Heart, LogOut, Settings, FileText, Activity, Bell } from "lucide-react"
...
export function PatientSidebar() {
  ...
  const navItems = [
    { label: "Dashboard", href: "/patient/dashboard", icon: <Activity className="h-5 w-5" /> },
    { label: "My Records", href: "/patient/records", icon: <FileText className="h-5 w-5" /> },
    { label: "Health Alerts", href: "/patient/alerts", icon: <Bell className="h-5 w-5" /> },
      ...
      <div className="border-b border-border px-6 py-6">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-secondary">Patient Portal</p>
          </div>
        </div>
      </div>
